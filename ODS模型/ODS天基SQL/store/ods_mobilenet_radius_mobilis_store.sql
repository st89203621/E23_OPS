CREATE TABLE ods_mobile_radius(
    ...
    'group.id' = 'ods_mobile_radius_mobilis_store',
    'format.type' = 'avro',
...
CREATE TABLE v64_deye_dw_ods.ods_mobilenet_radius_mobilis_store (
    capture_time Bigint,
    msg_type String,
    action String,
    user_name String,
...
insert into
    v64_deye_dw_ods.ods_mobilenet_radius_mobilis_store /*+ OPTIONS('sink.partition-commit.delay'='1 min','sink.partition-commit.trigger' = 'process-time','sink.partition-commit.policy.kind'='metastore,success-file','partition.time-extractor.timestamp-pattern'='$capture_day $capture_hour:00:00') */
select
    capture_time,
    msg_type,
    action,
