...
CREATE TABLE ods_pr_proxy (
    ...
    'type' = 'kafka',
    'topic' = 'ods_pr_source_0020_proxy',
...
CREATE TABLE v64_deye_dw_ods.ods_pr_proxy_store (
    stream_end_time long,
    N010007 string,
    session_id string,
    capture_time long,
...
INSERT INTO
 v64_deye_dw_ods.ods_pr_proxy_store
SELECT
    stream_end_time,
    N010007,
    session_id,
