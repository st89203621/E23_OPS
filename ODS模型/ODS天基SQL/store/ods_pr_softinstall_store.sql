...
CREATE TABLE ods_pr_softinstall (
data_type String,
data_source String,
...
extend_column String
    ...
    'group.id' = 'ods_pr_softinstall_store',
...
CREATE TABLE v64_deye_dw_ods.ods_pr_softinstall_store (
data_type String,
data_source String,
protocol_type String,
child_type String,
...
INSERT INTO 
 v64_deye_dw_ods.ods_pr_softinstall_store
SELECT
