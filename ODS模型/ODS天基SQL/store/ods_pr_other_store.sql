...
CREATE TABLE ods_pr_other (
    ...
    'type' = 'kafka',
    'topic' = 'ods_pr_source_9999_other',
...
CREATE TABLE v64_deye_dw_ods.ods_pr_other_store (
    stream_end_time string,
    session_id string,
    capture_time long,
    M040007 string,
...
INSERT INTO
 v64_deye_dw_ods.ods_pr_other_store
SELECT
    stream_end_time,
    session_id,
    capture_time,
