...
CREATE TABLE ods_pr_remotectrl (
data_type String,
data_source String,
...
browse_type String
    ...
    'group.id' = 'ods_pr_remotectrl_store',
...
CREATE TABLE v64_deye_dw_ods.ods_pr_remotectrl_store (
data_type String,
data_source String,
protocol_type String,
child_type String,
...
INSERT INTO 
 v64_deye_dw_ods.ods_pr_remotectrl_store
SELECT
