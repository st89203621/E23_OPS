...
CREATE TABLE ods_pr_dns (
    ...
    'type' = 'kafka',
    'topic' = 'ods_pr_source_my0020_dns',
...
CREATE TABLE v64_deye_dw_ods.ods_pr_dns_store (
    stream_end_time long,
    session_id string,
    capture_time long,
    M040007 string,
...
INSERT INTO
 v64_deye_dw_ods.ods_pr_dns_store
SELECT
	stream_end_time,
	session_id,
	capture_time,
