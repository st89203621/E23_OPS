CREATE TABLE v64_deye_dw_ods.ods_nf_domain_flux(
  data_type     Integer,
  user_group    String,
  user_name     String,
  strsrc_ip     String,
...
CREATE TABLE v64_deye_dw_ods.ods_nf_domain_flux_store(
  data_type     Integer,
  user_group    String,
  user_name     String,
  strsrc_ip     String,
...
insert into v64_deye_dw_ods.ods_nf_domain_flux_store
select
  data_type,
  user_group,
  user_name,
...
from v64_deye_dw_ods.ods_nf_domain_flux
