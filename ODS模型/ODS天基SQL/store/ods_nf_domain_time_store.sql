CREATE TABLE v64_deye_dw_ods.ods_nf_domain_time(
  data_type      Integer,
  user_group     String,
  user_name      String,
  strsrc_ip      String,
  ...
  insert_min     String
    ...
    'table.exec.hive.infer-source-parallelism.max' = '16'
    );

CREATE TABLE v64_deye_dw_ods.ods_nf_domain_time_store(
  data_type      Integer,
  user_group     String,
  user_name      String,
  strsrc_ip      String,
...
insert into v64_deye_dw_ods.ods_nf_domain_time_store
select
  data_type,
  user_group,
  user_name,
...
from v64_deye_dw_ods.ods_nf_domain_time
