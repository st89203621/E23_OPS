...
fault_flag Integer
      ...
      'type' = 'kafka',
    'topic' = 'deye_ods_voip_fax_dr_test',
    ...
    'group.id' = 'ods_voip_fax_dr_store',
...
CREATE TABLE v64_deye_dw_ods.deye_ods_voip_fax_dr_test (
strsrc_ip String,
strdst_ip String,
sender_from_url String,
receiver_to_url String,
...
INSERT INTO 
 v64_deye_dw_ods.deye_ods_voip_fax_dr_test
SELECT
