...
CREATE TABLE ods_pr_source_0029_weblogin (
  data_type String,
  data_source String,
  ...
  'type' = 'kafka',
  'topic' = 'ods_pr_source_0029_weblogin',
...
CREATE TABLE ods_pr_source_my0933_webid (
  data_type String,
  data_source String,
  protocol_type String,
  child_type String,
  ...
  'type' = 'kafka',
  'topic' = 'ods_pr_source_my0933_webid',
  'bootstrap.servers' = 'hdp-01:6667,hdp-02:6667,hdp-03:6667,hdp-04:6667,hdp-07:6667,hdp-05:6667,hdp-06:6667,hdp-08:6667',
  'zookeeper.connect' = 'hdp-01:2181,hdp-02:2181,hdp-03:2181,hdp-04:2181,hdp-07:2181,hdp-05:2181,hdp-06:2181',
  'group.id' = 'dwd_pr_others',
  'security.mode.flag' = 'false',
...
CREATE TABLE ods_pr_source_my1038_basewifi (
  data_type String,
  data_source String,
  protocol_type String,
  child_type String,
  ...
  'type' = 'kafka',
  'topic' = 'ods_pr_source_my1038_basewifi',
  'bootstrap.servers' = 'hdp-01:6667,hdp-02:6667,hdp-03:6667,hdp-04:6667,hdp-07:6667,hdp-05:6667,hdp-06:6667,hdp-08:6667',
  'zookeeper.connect' = 'hdp-01:2181,hdp-02:2181,hdp-03:2181,hdp-04:2181,hdp-07:2181,hdp-05:2181,hdp-06:2181',
  'group.id' = 'dwd_pr_others',
  'security.mode.flag' = 'false',
...
FROM
    (
        SELECT
            ...
            `domain` as `domain`,
            '' as relative_url,
            deyeSubDomainNorm(`domain`) as sub_domain,
            deyeSuperDomainNorm(`domain`) as super_domain,
            '' as app_name,
            '' as app_type,
      ...
      LATERAL TABLE(deyeTimeHandle(capture_time)) as T9(capture_day_l, capture_hour_l)
        ...
        SELECT
            ...
            my_base as my_base,
            my_wifi as my_wifi,
            nearby_base as nearby_base,
            nearby_wifi as nearby_wifi,
...
SELECT
  ...
  t1.relative_url as relative_url,
  ...
  t1.my_base as my_base,
  t1.my_wifi as my_wifi,
  t1.nearby_base as nearby_base,
  t1.nearby_wifi as nearby_wifi,
  t1.coordinate_type as coordinate_type,
