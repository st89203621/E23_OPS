...
CREATE TABLE ods_pr_source_0003_ftp (
  data_type String,
  data_source String,
...
SELECT
  ...
  IF(child_type IN('1050001','1050002','1059998'),deyeCompleteChildTypeMap(child_type, data_type)[1],'1059999') AS sub_protocol,
  IF(child_type IN('1050001','1050002','1059998'),deyeCompleteChildTypeMap(child_type, data_type)[2],deyeCompleteChildTypeMap('1059999', data_type)[2]) AS sub_protocol_map,
