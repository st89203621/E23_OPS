...
CREATE TABLE ods_pr_source_0014_remotectrl (
  data_type String,
  data_source String,
  ...
  'type' = 'kafka',
  'topic' = 'ods_pr_source_0014_remotectrl',
...
CREATE TABLE dwd_pr_remotectrl (
  data_type String,
...
SELECT
  ...
  deyeCompleteBrowseTypeMap(deyeBrowseTypeNorm(browse_type)) as browse_type_map,
  ...
  deyeSuperDomainNorm(deyeHostUrlTagParse(host_url_tag)[1]) as super_domain,
  '' as app_name,
  '' as app_type,
