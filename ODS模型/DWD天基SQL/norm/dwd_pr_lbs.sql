...
CREATE TABLE ods_pr_source_0044_lbs (
  data_type String,
  data_source String,
...
SELECT
  ...
  coordinate_type as coordinate_type,
  hospitalized_date as hospitalized_date,
